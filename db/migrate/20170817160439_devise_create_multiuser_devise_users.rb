class DeviseCreateMultiuserDeviseUsers < ActiveRecord::Migration[5.1]
  def change
    create_table :multiuser_devise_users do |t|
    ...
    add_index :multiuser_devise_users, :email, unique: true
