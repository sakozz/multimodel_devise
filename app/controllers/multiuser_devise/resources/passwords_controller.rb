class MultiuserDevise::Resources::PasswordsController < Devise::PasswordsController
  ...
  def password_error(status)
    MultiuserDevise::ErrorReport.generate({password: [t(".password_empty_or_not_matched")]}, status)
  end
end
